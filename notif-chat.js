...
function cargarChats() {
    ...
    const q = query(collection(db,'chats'), where('participantes','array-contains',miUID), orderBy('ultimaFecha','desc'), limit(30));
        ...
        snap.forEach(d => {
            ...
            div.innerHTML = `
                ...
                <div style="flex:1;min-width:0">
                    ...
                    <p style="font-size:11px;color:#52525b;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${esc(c.ultimoMensaje||'')}</p>
                </div>
    ...
    }, err => { el.innerHTML = '<p style="color:#52525b;font-size:11px;text-align:center;padding:40px 0">Error.</p>'; console.error(err); });
}
